...
class TaxiHourAggregation(models.Model):
	...
	gebied = models.CharField(max_length=255, null=False)
	electric = models.IntegerField(null=False)
	unieke_passages = models.IntegerField(null=False)
	check_on_camera_count = models.IntegerField(null=False)


class HulptabelCameragebiedenTaxidashboard (models.Model):
	id = models.CharField(max_length=255, primary_key=True)
	gebiedstype =  models.CharField(max_length=255, null=False)
	gebied = models.CharField(max_length=255, null=False)
	camera_id = models.CharField(max_length=255, null=False)
